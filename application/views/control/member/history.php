    ...
    <div class="row">
            <div class="col-md-12" style="padding: 10px;">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <div class="col-md-12">
                    <form action="<?php echo base_url('search-history');?>" method="POST" id="formCari">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select required class="form-control" name="idboard" id="idboard">
                                            <option value="" disabled selected >Pilih</option>
                                            <?php foreach($boardkey as $dv){;?>
                                                <option value="<?php echo $dv->idboard;?>" <?php echo $dv->idboard == $idboard?'selected':'';?> ><?php if(empty($dv->nameboard)){echo $dv->idboard;}else{echo $dv->nameboard;};?></option>
                                            <?php };?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date" value="<?php echo $dateP ;?>" id="dateP" name="dateP" required placeholder="Date">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date" value="<?php  echo $dateK ;?>" id="dateK" name="dateK" required placeholder="Date">
